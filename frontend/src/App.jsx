...
function App() {
  return (
    <Routes>
      ...
      {/* Supervisor Routes - so-us */}
      <Route 
        path="/supervisor" 
        element={
          <ProtectedRoute allowedRoles={['supervisor']} allowedSubroles={['so-us']}>
            <SupervisorLayout />
          </ProtectedRoute>
        }
      >
      ...
      {/* Supervisor Routes - ds-js */}
      <Route 
        path="/supervisor" 
        element={
          <ProtectedRoute allowedRoles={['supervisor']} allowedSubroles={['ds-js']}>
            <SupervisorLayoutds />
          </ProtectedRoute>
        }
      >
      ...
      {/* Supervisor Routes - sec */}
      <Route 
        path="/supervisor" 
        element={
          <ProtectedRoute allowedRoles={['supervisor']} allowedSubroles={['sec']}>
            <SupervisorLayoutsec />
          </ProtectedRoute>
        }
      >
      ...
      {/* Supervisor Routes - cio-io */}
      <Route 
        path="/supervisor" 
        element={
          <ProtectedRoute allowedRoles={['supervisor']} allowedSubroles={['cio-io']}>
            <SupervisorLayoutcio />
          </ProtectedRoute>
        }
      >
      ...
      {/* Supervisor Routes - dea-assis */}
      <Route 
        path="/supervisor" 
        element={
          <ProtectedRoute allowedRoles={['supervisor']} allowedSubroles={['dea-assis']}>
            <SupervisorLayoutdea />
          </ProtectedRoute>
        }
      >
      ...
      <Route 
        path="/lokayukt" 
        element={
          <ProtectedRoute allowedRoles={['lok-ayukt']}>
            <LokayuktLayout />
          </ProtectedRoute>
        }
      >
