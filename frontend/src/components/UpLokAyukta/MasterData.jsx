...
const Pagination = ({ currentPage, totalPages, onPageChange, totalItems, itemsPerPage, tabName }) => {
...
// Edit Modal Component with Simplified Error Handling
const EditModal = ({ 
  isOpen, 
  onClose, 
  activeTab, 
...
// Add Modal Component with Simplified Error Handling
const AddModal = ({ 
  isOpen, 
  onClose, 
  activeTab, 
...
const MasterData = () => {
  ...
  // Individual page change handlers for each tab
                  ...
                  <tr key={`${tabId}-${item.id}`} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-2 sm:py-3 px-2 sm:px-3">
                      <div className="flex gap-1 sm:gap-2">
                        ...
                        <button className="px-1.5 sm:px-2 py-1 border rounded text-xs hover:bg-gray-50" title="Delete">
