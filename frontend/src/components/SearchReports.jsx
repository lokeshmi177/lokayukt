          ...
          <div className="border-b border-gray-200 overflow-hidden">
            <nav className="flex w-full" aria-label="Tabs">
              <button
                ...
                className={`flex-1 py-3 sm:py-4 px-1 sm:px-2 text-xs sm:text-sm font-medium border-b-2 text-center min-w-0 ${
                  activeTab === 'search'
                    ? 'border-blue-500 text-blue-600'
                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                }`}
              >
                <span className="truncate block">Advanced Search</span>
              </button>
              <button
              ...
              >
                <span className="truncate block">General Reports</span>
              </button>
              <button
              ...
              >
                <span className="truncate block">Statistical Reports</span>
              </button>
              <button
              ...
              >
                <span className="truncate block">Compliance Reports</span>
              </button>
            </nav>
          </div>
